...
const Hero = () => {
  return (
    <div className={`${poppins.className} bg-gradient-to-r from-blue-500 to-indigo-700 text-white py-24 px-8 sm:px-40`}>
      <div className="container mx-auto flex flex-col-reverse md:flex-row items-center justify-between space-y-12 md:space-y-0">
        ...
        <div className="text-center md:text-left max-w-lg space-y-6">
          <h1 className={`${roboto.className} text-5xl font-semibold leading-tight text-white mb-4`}>
            CUREIFY
          </h1>
          ...
          <div className="flex justify-center md:justify-start">
            <a
              href="https://cureifyy.streamlit.app/"
