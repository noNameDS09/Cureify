  ...
  return (
    <section className="py-20 bg-gradient-to-r from-blue-100 via-blue-200 to-blue-300 text-gray-900">
      <div className="max-w-7xl mx-auto px-8 sm:px-16">
        <h2 className={`${roboto.className} text-4xl font-semibold text-center text-blue-700 mb-12`}>
          Discover How Cureify Revolutionizes Healthcare
        </h2>

        {/* Introduction */}
        <div className="text-center max-w-3xl mx-auto mb-16">
          <p className={`${poppins.className} text-lg leading-relaxed text-gray-700`}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
          ...
          <div className="p-6 bg-white rounded-xl shadow-xl hover:scale-105 transition-all duration-300">
            <h3 className={`${roboto.className} text-xl font-semibold text-blue-600 mb-4`}>Multi-Modal Input Handling</h3>
          ...
          {/* Feature 2 */}
          <div className="p-6 bg-white rounded-xl shadow-xl hover:scale-105 transition-all duration-300">
            <h3 className={`${roboto.className} text-xl font-semibold text-blue-600 mb-4`}>Symptom Analysis and Follow-Up</h3>
            <p className={`${poppins.className} text-gray-700`}>
          ...
          {/* Feature 3 */}
          <div className="p-6 bg-white rounded-xl shadow-xl hover:scale-105 transition-all duration-300">
            <h3 className={`${roboto.className} text-xl font-semibold text-blue-600 mb-4`}>Image Processing Capabilities</h3>
            <p className={`${poppins.className} text-gray-700`}>
          ...
          {/* Feature 4 */}
          <div className="p-6 bg-white rounded-xl shadow-xl hover:scale-105 transition-all duration-300">
            <h3 className={`${roboto.className} text-xl font-semibold text-blue-600 mb-4`}>Medical Knowledge Integration</h3>
            <p className={`${poppins.className} text-gray-700`}>
          ...
          {/* Feature 5 */}
          <div className="p-6 bg-white rounded-xl shadow-xl hover:scale-105 transition-all duration-300">
            <h3 className={`${roboto.className} text-xl font-semibold text-blue-600 mb-4`}>Remote and Intuitive Accessibility</h3>
            <p className={`${poppins.className} text-gray-700`}>
        ...
        <div className="bg-blue-50 py-12 px-8 sm:px-16 rounded-xl mb-16">
          <h3 className={`${roboto.className} text-2xl font-semibold text-center text-blue-700 mb-8`}>
            Impact and Benefits
          </h3>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="bg-white p-6 rounded-xl shadow-xl">
              <h4 className={`${roboto.className} text-lg text-center font-semibold text-blue-600 mb-4`}>Enhanced Healthcare Accessibility</h4>
              <p className={`${poppins.className} text-gray-700 text-center`}>
            ...
            <div className="bg-white p-6 rounded-xl shadow-xl">
              <h4 className={`${roboto.className} text-lg text-center font-semibold text-blue-600 mb-4`}>Improved Diagnostic Accuracy</h4>
              <p className={`${poppins.className} text-gray-700 text-center`}>
            ...
            <div className="bg-white p-6 rounded-xl shadow-xl">
              <h4 className={`${roboto.className} text-lg text-center font-semibold text-blue-600 mb-4`}>Cost Efficiency</h4>
              <p className={`${poppins.className} text-gray-700 text-center`}>
            ...
            <div className="bg-white p-6 rounded-xl shadow-xl">
              <h4 className={`${roboto.className} text-lg text-center font-semibold text-blue-600 mb-4`}>Proactive Health Management</h4>
              <p className={`${poppins.className} text-gray-700 text-center`}>
        ...
        <div className="text-center mb-16">
          <h3 className={`${roboto.className} text-2xl font-semibold text-blue-700 mb-6`}>
            Innovation and Technology
          </h3>
          <p className={`${poppins.className} text-lg leading-relaxed text-gray-700 max-w-3xl mx-auto`}>
